/*
 ...
 On a désormais une triple poulie pour piloter en meme temps les trois derniers doigts.
...
int mainouverte[] = {170, 0, 179};  //rangpositioncible 0
int montredoigt[] ={0, 0, 0};       //rangpositioncible 1
int valise[] = {10, 179, 10};       //rangpositioncible 2
int grandepince[]={30, 80, 179};    //rangpositioncible 3
...
int M1;  //valeur renvoyee par le premier capteur musculaire (interieur)
int M2;  //valeur renvoyee par le deuxieme capteur musculaire (exterieur)
...
void loop()
{
  ...
  //ICI changement.
  if(flagM2 && taquet)  {
    Serial.print("Changement de position cible");
    delay(1000);
    ...
    if(superTarget == 3)
      ...
      superTarget++;
    #ifdef DEBUG
    Serial.print(", la nouvelle position cible est :");
    Serial.print(superTarget);
